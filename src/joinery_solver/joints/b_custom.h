// b_custom: user-supplied joint geometry for b (beam, type 60).
// Port of wood_joint_lib.cpp:5948-5971 — reads pairs (i, i+1) from
// CUSTOM_JOINTS_B_MALE/FEMALE. Each pair = (face0, face1) polyline.
//
...
static void b_custom(WoodJoint& joint) {
    ...
    const auto& cm = wood_session::globals::CUSTOM_JOINTS_B_MALE;
    const auto& cf = wood_session::globals::CUSTOM_JOINTS_B_FEMALE;
