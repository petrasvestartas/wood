...
private:
    ...
    std::array<std::vector<session_cpp::Polyline>, 2>* joint_outlines(InteractionFeaturePlate& joint, size_t face, int joint_id, bool male_or_female) const;
    ...
    void flip_and_insert_cut(const InteractionFeaturePlate& joint, std::array<std::vector<session_cpp::Polyline>, 2>& outlines, size_t face, int joint_id, bool male_or_female);
    ...
    void cut_holes_top_bottom(const std::vector<std::vector<std::pair<int, bool>>>& membership, std::vector<InteractionFeaturePlate>& joints, std::vector<session_cpp::Polyline>& result) const;
    ...
    void cut_holes_side(const std::vector<std::vector<std::pair<int, bool>>>& membership, std::vector<InteractionFeaturePlate>& joints, std::vector<session_cpp::Polyline>& result) const;
};
