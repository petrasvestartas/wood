// cr_c_ip_custom: user-supplied unit-cube joint geometry for cr_c_ip (type 30).
// Port of wood_joint_lib.cpp:5476-5527 — reads pairs (i, i+1) from
// CUSTOM_JOINTS_CR_C_IP_MALE/FEMALE. Each pair = (face0, face1) polyline.
//
...
static void cr_c_ip_custom(WoodJoint& joint) {
    joint.name = "cr_c_ip_custom";

    const auto& cm = wood_session::globals::CUSTOM_JOINTS_CR_C_IP_MALE;
    const auto& cf = wood_session::globals::CUSTOM_JOINTS_CR_C_IP_FEMALE;
