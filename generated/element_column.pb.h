...
/* @@protoc_insertion_point(class_definition:wood_proto.Column) */ {
 ...
 public:
  ...
  bool has_axis() const;
  void clear_axis() ;
  const ::session_proto::Line& axis() const;
  ...
  void clear_section() ;
  const ::session_proto::Polyline& section() const;
...
inline ::google::protobuf::RepeatedPtrField<::session_proto::Polyline>* PROTOBUF_NONNULL Column::mutable_profile()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
