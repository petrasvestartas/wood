// ts_e_p_custom: user-supplied unit-cube joint geometry for ts_e_p (type 20).
// Port of wood_joint_lib.cpp:4545-4591 — reads pairs (i, i+1) from
// CUSTOM_JOINTS_TS_E_P_MALE/FEMALE. Each pair = (face0, face1) polyline for
// one outline entry.
//
...
static void ts_e_p_custom(WoodJoint& joint) {
    ...
    const auto& cm = wood_session::globals::CUSTOM_JOINTS_TS_E_P_MALE;
    const auto& cf = wood_session::globals::CUSTOM_JOINTS_TS_E_P_FEMALE;
