...
/**
 * Get closest distance and closest edge to a polyline, by iterating each line segment and measuring
 * the distance
 *
 * @param [in] point point to search from
 ...
 * @param [in] input_points_types joint type indices assigned to each point, thus the number of
