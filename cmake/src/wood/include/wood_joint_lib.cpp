...
bool
read_xml (wood::joint &joint, int type)
{
    try
        {
            ...
            if (!exists_file (wood::GLOBALS::PATH_AND_FILE_FOR_JOINTS))
                {
                    ...
                    printf ("\nCPP File does not "
                            "exist %s ",
                            wood::GLOBALS::PATH_AND_FILE_FOR_JOINTS.c_str ());
#endif
            ...
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            // Get Property to find the right
            ...
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            // Get properties from XML and add to
            // joint
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            try
                {
            ...
            // myfile << "Good Result\n";
            // myfile.close();
            // CGAL_Debug(joint.f[0].size(),
            // joint.f[1].size(),
            // joint.f_boolean_type.size());
            // CGAL_Debug(joint.m[0].size(),
            // joint.m[1].size(),
            // joint.m_boolean_type.size());
            // printf("Exists \n");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Main geometry methods used in
// cgal_inscribe_util to be used as self-contained
...
length (double x, double y, double z)
{
    ...
    //     For small denormalized doubles
    //     (positive but smaller than DBL_MIN),
    //     some compilers/FPUs set 1.0/x to +INF.
    //     Without the ON_DBL_MIN test we end up
    //     with microscopic vectors that have
    //     infinte length!
    //
    //     This code is absolutely necessary.  It
    //     is a critical part of the bug fix for
    //     RR 11217.
    if (x > ON_DBL_MIN)
        {
            y /= x;
...
double
remap_numbers (const double &value_to_remap, const double &low0, const double &high0, const double &low1, const double &high1)
{
    return low1 + (value_to_remap - low0) * (high1 - low1) / (high0 - low0);
}

double
lerp (const double &value0, const double &value1, const double &t)
{
...
void
side_removal (wood::joint &jo, std::vector<wood::element> &elements, bool merge_with_joint)
{
    try
        {
            jo.name = __func__;
            ...
            // edge of the side 2) Create
            // wood::joint in XY plane and orient
            // it to the two rectangles 3) Clipper
            // boolean difference, cut wood::joint
            // polygon form the outline
            /////////////////////////////////////////////////////////////////////////////////
            ...
            /////////////////////////////////////////////////////////////////////////////////
            // output, no need to merge if already
            // cut
            /////////////////////////////////////////////////////////////////////////////////
            ...
            if (jo.shift > 0 && merge_with_joint)
                ...
                {
                    jo.m[0] = { pline0, pline0 };

                    jo.m[1] = { pline0_moved0, pline0_moved0 };
                }

            jo.f[0] = { pline1, pline1 };

            jo.f[1] = { pline1_moved, pline1_moved };
    ...
    catch (const std::exception &ex)
        {
            ...
            // You can log the error, print a
            // message, or take any other
            // appropriate action
            std::cerr << "An exception occurred: " << ex.what () << std::endl;
        }
    catch (...) // Catch all other types of
                // exceptions
        {
...
ss_e_ip_1 (wood::joint &joint)
{
    ...
    // rectangle is not a wood::joint but an
    // cutting wood::element
    joint.f[0] = { pline0, { pline0.front (), pline0.back () } };

    joint.f[1] = { pline1, { pline1.front (), pline1.back () } };

    joint.m[0] = { pline0, { pline0.front (), pline0.back () } };

    joint.m[1] = { pline1, { pline1.front (), pline1.back () } };
...
void
ss_e_ip_2 (wood::joint &joint, std::vector<wood::element> &elements)
{
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // joint parameters
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Copy the default shapes and move them by
    // merging
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    auto a = joint.m[0];
    ...
    for (auto i = 0; i < divisions; i++)
        {
            // copy the first outline, be sure
            ...
            // segment and then back by half of
            // the division length
...
void
ss_e_ip_5 (wood::joint &joint, std::vector<wood::element> &elements)
{
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // joint parameters
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void
ss_e_ip_custom (wood::joint &joint)
{
    joint.name = __func__;
...
void
ss_e_op_4 (wood::joint &joint, double t, bool chamfer, bool female_modify_outline, double x0, double x1, double y0, double y1, double z_ext0, double z_ext1) //
{
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //             joint.f[i][j].size(); k++)
    //                 joint.f[i][j][k] =
    //                 joint.f[i][j][k].transform(scale_xform);
    ...
    //             joint.m[i][j].size(); k++)
    //                 joint.m[i][j][k] =
    //                 joint.m[i][j][k].transform(scale_xform);
...
void
ss_e_op_5 (wood::joint &jo, std::vector<wood::joint> &all_joints, bool disable_joint_divisions)
{
    // return;
    ...
    int a = 0;
    int b = 1;
    all_joints[jo.linked_joints[a]].divisions = jo.divisions; // division must be the
                                                              // same to merge two
                                                              // joints correctly
    ss_e_op_4 (all_joints[jo.linked_joints[a]], 0.5, true, false, -0.5, 0.5, -0.5, 0.5, -0.5, 0.5);

    // set wood::joint sequences for wood::joint 0
    // and wood::joint 1
    // std::vector<std::vector<std::array<int,
    // 4>>> linked_joints_seq; // assigned on
    // wood::joint_library | it is nested because
    // there can be umber of polylines | example
    // {start_curr,step_curr} means that
    // "start_curr+step_curr*i" and
    // {start_link,step_link} ->
    // "start_link+step_link*i" wood::joint 0 -
    // there is only one polyline
    ...
    if (jo.linked_joints.size () == 2)
        {
            // create geometry for linked
            // wood::joint 1
            all_joints[jo.linked_joints[b]].divisions = disable_joint_divisions ? jo.divisions * 0 : jo.divisions; // division
                                                                                                                   // must be
                                                                                                                   // the same
                                                                                                                   // to merge
                                                                                                                   // two
    ...
    // std::cout << "linked_joints " <<
    // jo.linked_joints_seq.size() << "\n";
}

void
ss_e_op_6 (wood::joint &jo, std::vector<wood::joint> &all_joints)
{
...
void
ss_e_op_custom (wood::joint &joint)
{
    joint.name = __func__;
...
void
ss_e_r_0 (wood::joint &jo, std::vector<wood::element> &elements)
{
    jo.name = __func__;
    jo.orient = false;
...
void
ss_e_r_1 (wood::joint &joint, int type)
{
    // Miter tenon-mortise
    joint.name = __func__;
...
void
side_removal_ss_e_r_1 (wood::joint &jo, std::vector<wood::element> &elements, bool merge_with_joint)
{
    jo.name = __func__;
    jo.orient = false;
    std::swap (jo.v0, jo.v1);
    ...
    // side 2) Create wood::joint in XY plane and
    // orient it to the two rectangles 3) Clipper
    // boolean difference, cut wood::joint polygon
    // form the outline
    /////////////////////////////////////////////////////////////////////////////////
    ...
    if (merge_with_joint)
        {
            // 2) Create wood::joint in XY plane
            // and orient it to the two rectangles
            wood::joint joint_2;
            // bool read_successful =
            // internal::read_xml(joint_2,
            // jo.type);
            ss_e_r_1 (joint_2);
            ...
            // printf("xml tile reading number of
            // polyines %iz",
            // joint_2.m[0].size());
            if (read_successful)
                {
                    ...
                    // wood::cut::conic_offset);
                    // printf("\n %f",
                    // wood::cut::conic_offset_opposite);

                    double offset_value = -(1.0 * conic_offset_opposite) - conic_offset; // was 1.5
                                                                                         // ERROR
                                                                                         // possible
                                                                                         // here,
                                                                                         // check
                    ...
                    for (int i = 0; i < joint_2.m[0].size (); i++)
                        {
                            // cgal_polyline_util::reverse_if_clockwise(joint_2.f[0][i],
                            // plane_0_0);
                            collider::clipper_util::offset_in_3d (joint_2.m[0][i], plane_0_0,
                                                                  offset_value); // 0.1 means more tighter
                            // double value = -(2
                            // * wood::cut::conic_offset_opposite) -
                            // wood::cut::conic_offset;
                            // printf("reult %f ",
                            ...
                            // printf("reult %f ",
                            // wood::cut::conic_offset
                            // +wood::cut::conic_offset_opposite);//shOULD
                            // BE THIS
                        }

                    for (int i = 0; i < joint_2.m[1].size (); i++)
                        {
                            // cgal_polyline_util::reverse_if_clockwise(joint_2.f[1][i],
                            // plane_0_0);
                            collider::clipper_util::offset_in_3d (joint_2.m[1][i], plane_0_0, offset_value);
                        }

                    // printf("xml tile reading
                    // number of polyines %iz" ,
                    // joint_2.m[0].size());

                    // 3) Clipper boolean
                    // difference, cut wood::joint
                    // polygon form the outline

                    // Merge male, by performing
                    // boolean union
                    ...
                    for (int i = 0; i < joint_2.f[0].size (); i++)
                        {
                            // cgal_polyline_util::reverse_if_clockwise(joint_2.f[0][i],
                            // plane_0_0);
                            // collider::clipper_util::offset_in_3d(joint_2.f[0][i],
                            // plane_0_0,
                            // wood::cut::conic_offset_opposite);//-
                            // wood::cut::conic_offset
                        }
                    ...
                    for (int i = 0; i < joint_2.f[1].size (); i++)
                        {
                            // collider::clipper_util::offset_in_3d(joint_2.f[1][i],
                            // plane_0_0,
                            // wood::cut::conic_offset_opposite);//
                            // -
                            // wood::cut::conic_offset
...
void
ss_e_r_custom (wood::joint &joint)
{
    joint.name = __func__;
...
void
ss_e_r_2 (wood::joint &joint, std::vector<wood::element> &elements)
{
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // joint parameters
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // update the joint volume rectangle to fixed
    // size e.g. 100x100x100
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for (auto &joint_volume : joint.joint_volumes)
        {
            ...
            joint_volume = {
                ...
                center + x_dir + 2 * y_dir, center - x_dir + 2 * y_dir, center - x_dir, center + x_dir, center + x_dir + 2 * y_dir,
            };
        }
...
void
ss_e_r_3 (wood::joint &joint, std::vector<wood::element> &elements)
{
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // joint parameters
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
ts_e_p_3 (wood::joint &joint)
{
...
#ifdef DEBUG_JOINERY_LIBRARY
    printf ("\nCPP <<File>> "
            "wood::joint_library.h <<Method>> "
            "ts_e_p_3 <<Description>> Joint Main "
            "Parameters");
#endif
    ...
    printf ("\nCPP <<File>> "
            "wood::joint_library.h <<Method>> "
            "ts_e_p_3 <<Description> Interpolate "
            "Points");
#endif
...
#ifdef DEBUG_JOINERY_LIBRARY
    printf ("\nCPP <<File>> wood::joint_library.h "
            "<<Method>> ts_e_p_3 <<Description> Move "
            "Segments");
#endif
...
#ifdef DEBUG_JOINERY_LIBRARY
    printf ("\nCPP <<File>> wood::joint_library.h "
            "<<Method>> ts_e_p_3 <<Description> "
            "Create Polylines");
#endif
}

void
ts_e_p_4 (wood::joint &joint)
{
    joint.name = __func__;
    ...
    joint.m_boolean_type = {
        wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project,
        wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::slice,        wood::cut::slice,        wood::cut::slice,        wood::cut::slice,
    };
    ...
    // '6', '6', '6', '6', '6' , '6', '6' };
    // joint.m_boolean_type = { '6', '6', '6',
    // '6', '6', '6', '6', '6' , '6', '6'  , '4',
    // '4' , '4', '4' };
}

void
ts_e_p_5 (wood::joint &joint)
{
...
void
ts_e_p_custom (wood::joint &joint)
{
    // std::ofstream
    // outputFile("C:/compas_wood/output.txt");
    // outputFile <<
    // wood::GLOBALS::CUSTOM_JOINTS_TS_E_P_MALE.size()
    // << std::endl; outputFile <<
    // wood::GLOBALS::CUSTOM_JOINTS_TS_E_P_FEMALE.size()
...
cr_c_ip_1 (wood::joint &joint)
{
    ...
    joint.m_boolean_type = {
        wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::slice,
        wood::cut::slice,        wood::cut::slice,        wood::cut::slice,        wood::cut::slice,        wood::cut::slice,        wood::cut::slice,        wood::cut::slice,

        wood::cut::slice,        wood::cut::slice,        wood::cut::slice,        wood::cut::slice,
    };
    joint.f_boolean_type = { wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::mill_project, wood::cut::slice,
                             wood::cut::slice,        wood::cut::slice,        wood::cut::slice,        wood::cut::slice,        wood::cut::slice,        wood::cut::slice,        wood::cut::slice,
...
cr_c_ip_2 (wood::joint &joint)
{
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////
    // extend rectangles to both sides to
    ...
    joint.m_boolean_type = {
        ...
        wood::cut::slice_projectsheer, wood::cut::slice_projectsheer, wood::cut::slice_projectsheer, wood::cut::slice_projectsheer,

        wood::cut::mill_project,       wood::cut::mill_project,       wood::cut::mill_project,       wood::cut::mill_project,
...
cr_c_ip_5 (wood::joint &joint)
{
    ...
    joint.m_boolean_type = {
        ...
        wood::cut::drill_50,           wood::cut::drill_50,           wood::cut::drill_10,           wood::cut::drill_10,
    };
    joint.f_boolean_type = {
        wood::cut::mill_project,       wood::cut::mill_project,
...
void
cr_c_ip_custom (wood::joint &joint)
{
    // std::ofstream
    // outputFile("C:/compas_wood/output.txt");
    ...
    joint.name = __func__;
    // outputFile <<
    // wood::GLOBALS::CUSTOM_JOINTS_CR_C_IP_MALE.size()
    // << std::endl; outputFile <<
    // wood::GLOBALS::CUSTOM_JOINTS_CR_C_IP_FEMALE.size()
    // << std::endl; outputFile.close();  // Close
    // the file
          ...
          std::vector<wood::element> &elements) //
{
    ...
    // WARNING: set variable so that it wont be
    // recomputed, because it is run only once |
    // also it must not be orientable
    joint.orient = false;
    joint.key += std::to_string (joint.id);
}

void
tt_e_p_1 (wood::joint &joint,
          std::vector<wood::element> &elements) //
{
    joint.name = __func__;
...
void
tt_e_p_custom (wood::joint &joint)
{
    joint.name = __func__;
...
void
b_0 (wood::joint &joint)
{
    joint.name = __func__;
    joint.orient = false; // prevents wood::joint
                          // from copying
    ...
    // rect1, 0.25);//joint.shift
    // rect2=cgal_polyline_util::tween_two_polylines(rect2,
    // rect3, 0.25);
    // viewer_polylines.emplace_back(rect0);
    // viewer_polylines.emplace_back(rect1);
    // Create cutting geometry - two rectangles
    // that represents single line cut
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Key function that iterates through all joints
// and calls the function that constructs the
// joint geometry
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

void
construct_joint_by_index (std::vector<wood::element> &elements, std::vector<wood::joint> &joints, std::vector<double> &default_parameters_for_four_types, std::vector<double> &scale)
{
    /////////////////////////////////////////////////////////////////////
    // You must define new wood::joint each time
    // you internalize it
    /////////////////////////////////////////////////////////////////////
    ...
    joint_names[54] = "ss_e_r_3";
    joint_names[56] = "ss_e_r_2";
    ...
    // Store parameters as a string: "joint_type ;
    // divisions, not dist ; shift" If this
    // dictionary already has joints, fill
    // parameters: f, m, booleans, with existing
    // ones.
    //  This wood::joint is not oriented,
    //  orientation happens at the end of the loop
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Iterate joints constructed during search
    // methods
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for (auto &jo : joints)
        {
            counter++;
            if (jo.link) // skip link jont because
                         // they are generated
                         // inside main
                         // wood::joint and then
                         // orient below
            ...
            // When users gives an input ->
            // default_parameters_for_four_types
            int number_of_types = 7;      // side-side in-plane |
                                          // side-side out-of-plane |
                                          // top-side | cross | top-top
                                          // | side-side rotated
            int number_of_parameters = 3; // division_dist | shift |
                                          // type
            bool default_parameters_given = default_parameters_for_four_types.size () == (long long)(number_of_types * number_of_parameters);

            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            // Select first by local search, only
            // then by user given index, or by
            // default This setting produces
            // joints without geometry, do you
            // need to delete these joints?
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            // a) by wood::globals, when the scale
            // input is empty b) by user
            // TODO: think if this this property
            // can be replaced by
            // wood_global::JOINT_VOLUME_EXTENSION
            // property only
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            if (scale.size () > 0)
                {
                        ...
                        if (scale.size () == 0)
                            {
                                ...
                                // default scale:
                                // " <<
                                // wood::GLOBALS::JOINT_VOLUME_EXTENSION[0]
                                // << " " <<
                                // wood::GLOBALS::JOINT_VOLUME_EXTENSION[1]
                                // << " " <<
            ...
            // from the global parameters to local
            // joint parameters jo.shift
            // jo.divisions
            // Set unit distance, this value is a
            // distance between wood::joint volume
            // rectangles, in case this property
            // is set->unit_scale = true
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            if (default_parameters_given)
                {
                    ...
                    if (id_representing_joint_name == -1) // for cases when
                                                          // wood::joint
                                                          // types per each
                                                          // edge are not
                                                          // defined
            ...
            jo.get_divisions (division_length); // the
                                                // division_length
                                                // is assigne to
                                                // the
                                                // division_length
            ...
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            // Assign geometry to joints that
            // currently contains only adjacency
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            // std::cout << "_joint id: " << jo.id
            // << " " << unique_joints.count(key)
            // << " " << key
            // << std::endl; std::cout << "key "
            // << jo.get_key() << "links " <<
            // jo.linked_joints.size() <<
            // std::endl;
            if (is_similar_joint && jo.linked_joints.size () == 0) // skip linked
                                                                   // joints, that must
                                                                   // be regenerated
                                                                   // each time,
                                                                   // currently there is
            ...
            // jo.name << std::endl;
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            // Add to wood::joint map because this
            // wood::joint was not present
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if (jo.orient)
                {
                    ...
                    jo.orient_to_connection_area (); // and orient to
                                                     // connection volume

                    // special case for vidy only
                    // when joints must be merged
