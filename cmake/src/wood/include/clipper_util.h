 ...
 *
 * @param [in] input cgal polyline
 * @param [in] plane the plane of the polyline, the first point of the polyline is taken as the
 * origin
 * @param [out] output clipper polyline
 * @param [out] xform_to_xy_inv orientation matrix to 3D
 * @param [in] closed_polyline skips the last point from the cgal polyline
 ...
 * returns the result back to 3D The result igonores very small polygons within the tolerance:
 * wood::GLOBALS::CLIPPER_AREA) The user can choose to include the triangles in the result
 *
 ...
 * @param [in] intersection_type the default parameter: 0 - Intersect, 1 - Union, 2 - Difference, 3
 * - Xor
