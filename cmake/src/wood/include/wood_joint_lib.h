...
//
// INSTRUCTIONS:
// Joint geometry is added as a list of outlines with the last item as a boundary e.g. one line or
// rectangle The number of cut types is equal to the number of outlines + 1 boundary e.g.:
//
//
// ...
// joint.f[0].emplace_back(female_moved_0);
// joint.f[1].emplace_back(female_moved_1);
// joint.f[0].emplace_back(std::initializer_list<IK::Point_3>{joint.f[0].front()[0],
// joint.f[0].front()[3], joint.f[0].back()[2], joint.f[0].back()[1], joint.f[0].front()[0]});
// joint.f[1].emplace_back(std::initializer_list<IK::Point_3>{joint.f[1].front()[0],
// joint.f[1].front()[3], joint.f[1].back()[2], joint.f[1].back()[1], joint.f[1].front()[0]});
...
//
// Also do not forget that there are joint male outlines, there are two list of outlines to
// represent the top and the bottom outlines
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 * @param [in] type 0, 12 - ss_e_ip_9, 11,1 - ss_e_op_9, 20,2 - ts_e_p_9, 30,3 - cr_c_ip_9, 40,4 -
 * tt_e_p_9, 13,5 - ss_e_r_9, 60,6 - b_9
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Main geometry methods used in cgal::inscribe_util to be used as self-contained header and source
// file
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
...
/**
 * Unit joint - Side-to-side edge in-plane joints - plate Vidy tenon-mortise with different
 * configurations this joint is connected with methods: ss_e_op_5 and ss_e_op_6
 *
 * @param [in, out] joint node, to which geometry will be added
 ...
 */
void ss_e_op_4 (wood::joint &joint, double t = 0.00, bool chamfer = true, bool female_modify_outline = true, double x0 = -0.50, double x1 = 0.5, double y0 = -0.5, double y1 = 0.5, double z_ext0 = -0.5,
                double z_ext1 = 0.5);

/**
 * Unit joint - Side-to-side edge in-plane joints - plate Vidy tenon-mortise that has a specific
 * pair linking, therefore the joint has 2 additional methods
 *
 * @param [in, out] jo node, to which geometry will be added
 * @param [in] all_joints existing joints to find the links to add the mortise and join the tenons
 * @param [in] disable_joint_divisions this property is used by "ss_e_op_5" to to merge tenons only
 * with one side, this option is used in the Vidy Theather walls
 */
void ss_e_op_5 (wood::joint &jo, std::vector<wood::joint> &all_joints, bool disable_joint_divisions = false);

/**
 * Unit joint - Side-to-side edge in-plane joints - plate Vidy tenon-mortise that has a specific
 * pair linking, therefore the joint has 2 additional methods Vidy Theater Wall version, where only
 * one link is used due to the assembly sequence
 *
 * @param [in, out] joint node, to which geometry will be added
 * @param [in] all_joints existing joints to find the links to add the mortise and join the tenons
 */
 ...
 * This method creates a specific type of wood joint between two elements, modifying the provided
 * 'joint' object.
 *
 ...
 * @brief Unit joint - Side-to-side edge rotated joints.
 *
 * 3DEC custom joint based on ss_e_r_2
 * The joint is implemented from the HILTI system, via collaboration with Balteschwiler AG.
 * This method creates a specific type of wood joint between two elements, modifying the provided
 * 'joint' object.
 *
 ...
 * @param elements [in] Properties for the two elements that will be joined.
 */
void ss_e_r_3 (wood::joint &joint, std::vector<wood::element> &elements);
 ...
 *
 * @param [in, out] joint node, to which geometry will be added
 * @param [in] elements elements are needed to determina the joint thickness, since two plates can
...
/**
 * Unit joint - Cross cutting in-plane joints - beam simplified conical cuts from the Brussels
 * Sports Tower project (5 cuts and no drilling joles)
 *
 * @param [in, out] joint node, to which geometry will be added
 */
...
/**
 * Unit joint - Cross cutting in-plane joints - beam simplified conical cuts from the Brussels
 * Sports Tower project (5 cuts and two inclined drilling joles (1:5 brussels prototype))
 *
 * @param [in, out] joint node, to which geometry will be added
 */
...
/**
 * Unit joint - Cross cutting in-plane joints - beam simplified conical cuts from the Brussels
 * Sports Tower project (5 cuts and 1 vertical drilling hole)
 *
 * @param [in, out] joint node, to which geometry will be added
 */
...
/**
 * Unit joint - Cross cutting in-plane joints - beam simplified conical cuts from the Brussels
 * Sports Tower project (5 cuts and 1 vertical drilling hole one perpendicular to create the
 * dowel-nutl)
 *
 * @param [in, out] joint node, to which geometry will be added
 */
...
/**
 * Unit joint - Top-to-top edge plane joints - plate drill for one line segment at the center of the
 * intersection area types: drill center of the joint_area
 *
 ...
 *
 * @param joint node, to which geometry will be added
 * @param elements for the line length by element thickness, also could be done in two steps: a)
 * first line is added, then b) intersection is computed
 */
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Key function that iterates through all joints and calls the function that constructs the joint
// geometry
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 * @param scale joint volume scale values, for example triangle plates requires offset from edge
 * ends
 */
